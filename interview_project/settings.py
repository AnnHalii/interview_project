...
SECRET_KEY = "django-insecure-nj!_@w44op%!bl6%wun#%_$oa717r%w8gkz9&0$%2fmm7iqh-#"
...
INSTALLED_APPS = [
    ...
    "interview_project.apps.user_management",
    "interview_project.apps.url_management",
    "interview_project.apps.url_redirects",
]
